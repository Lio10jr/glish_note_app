...
class EditVocabularyPage extends StatefulWidget {
  final VocabularyNote objVocabulario;
  const EditVocabularyPage({super.key, required this.objVocabulario});

  @override
  State<EditVocabularyPage> createState() => EditVocabularyPageState();
}

class EditVocabularyPageState extends State<EditVocabularyPage> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: const PreferredSize(
          ...
          child: TitleWidget(tema: "Modifica una palabra tu Vocabulario"),
        ),
