...
class PageTranslation extends StatefulWidget {
  const PageTranslation({super.key});

  @override
  StatepagTranslation createState() => StatepagTranslation();
}

class StatepagTranslation extends State<PageTranslation> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: const PreferredSize(
          ...
          child: TitleWidget(tema: "Traductor"),
        ),
        body: Container(
