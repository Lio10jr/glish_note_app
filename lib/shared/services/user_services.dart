...
class UserServices {
  ...
  // Future<List<ImageCamera>> getImagenes(String email) async {
  //   List<ImageCamera> lisCamera = [];
  //   try {
  ...
  // Future saveImagenes(String email, String img, String imgurl, String fecha,
  //     String hora, String nota) async {
  //   try {
